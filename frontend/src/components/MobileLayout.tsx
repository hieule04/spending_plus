...
export default function MobileLayout({
  ...
  return (
    <div className="relative flex h-[100dvh] flex-col overflow-hidden overscroll-none bg-gray-50 dark:bg-slate-900 pt-[env(safe-area-inset-top)]">
      <main className="flex-1 overflow-y-auto hide-scrollbar overscroll-none pb-[calc(env(safe-area-inset-bottom)+4.2rem)]">{children}</main>

      <nav className="fixed bottom-0 left-0 right-0 z-40 rounded-t-3xl border-t border-gray-200 dark:border-slate-800 bg-white/95 dark:bg-slate-800/95 px-3 pt-2 pb-[calc(env(safe-area-inset-bottom)+4px)] shadow-[0_-10px_30px_rgba(15,23,42,0.08)] backdrop-blur">
